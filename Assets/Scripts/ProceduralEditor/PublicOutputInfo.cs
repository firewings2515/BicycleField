...
public static class PublicOutputInfo
{
    ...
    static public int piece_num = 32;                                                                   // The number of piece in a patch    ver2 = 8 ver3 = 64
    public static float piece_length = 1.0f;                                                            // 2
    ...
    public static int gaussian_m = 4;
    public static int tex_size = 65;                                                                    // 129
    public static int height_buffer_row_size = tex_size + 7;
    public static int pregaussian_tex_size = tex_size + 2 * gaussian_m;                                 // 129 + 32 = 161
    public static int height_with_gaussian_buffer_row_size = pregaussian_tex_size + 7;
